...
Recently also a corpus of movie subtitles has been compiled (ParTy by Levshina), but since that data comes with matching timelines the aligning task is very different.
