...
Naturally the current preferred standard would be representation with closely matching Unicode characters.
...
Some of these, such as Endangered Archives ran by the British Library, have focused mainly to audio and photograph mediums.
Others, namely Fenno-Ugrica and work done in Syktyvkar, are good examples from the systematic digitalization of written resources.
...
Komi-Permyak and Komi-Yazva will also be included in INEL in 2020-2023, which is relevant in the Permic context of this conference as well.
...
This is also a very particular case for OCR tools since the scripts used are often not included in available OCR models, the number of diacritics may make the scripts extremely complex and the fonts used may be very customized for specific publications.
...
Different OCR editors are very similar in their basic layout, and usually comprise of parallel pages with one half of the screen containing a frame for image and other for the recognized text.
However, many tools still tend to lack some features, the most critical of which are:

- Lack of search and replace with regular expressions [@mancinelli2016a, 259]
- Lack of XML export

The first issue connects to automatization of the proofreading process, since some mistakes are always systematic and could be easily corrected in post correction phase.
The export format causes a more serious issue.
